      ...
      <div className="container mx-auto bg-white py-6 px-6 md:py-0 md:px-0  rounded-xl md:flex gap-6 items-center loginShadow">
        ...
        <div className="flex flex-col items-center md:basis-1/2">
          ...
          <div className="flex items-center gap-4 border-b border-black pb-2 px-2 mb-8 w-full md:w-[80%] xl:w-[60%]">
            ...
            <input type="text" className="outline-none lg:text-lg" placeholder="New Password"/>
          </div>
          <div className="flex items-center gap-4 border-b border-black pb-2 px-2 mb-8 w-full md:w-[80%] xl:w-[60%]">
            <i className="fa-solid fa-lock"></i>
            <input type="text" className="outline-none lg:text-lg" placeholder="Confirm New Password"/>
          </div>
          <div className="md:w-[80%] xl:w-[60%] mt-10">
            <button className="text-center bg-accent hover:bg-primary duration-300 text-white py-3 px-12 rounded-xl text-xl block w-full">Finish</button>
          </div>
        </div>
      </div>
    </section>
